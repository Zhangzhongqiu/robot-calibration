...
f1(1).FaceColor='b';
f1(2).FaceColor='r';
set(gca,'xlim',[0 5],'YGrid','on','XTick',ed1,'XTickLabelRotation',45);
...
deg=pi/180;
theta=theta/deg;
edges2=(0:0.00016875:0.0135)/deg;
ed2=(0:0.00016875:0.01333125)/deg;
...
f2(1).FaceColor='b';
f2(2).FaceColor='r';
set(gca,'xlim',[0 0.0135/deg],'YGrid','on','XTick',ed2,'XTickLabelRotation',45);
